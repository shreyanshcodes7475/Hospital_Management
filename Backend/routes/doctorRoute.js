...
const { loginDoctor,getProfile,changeAvailability,updateProfile,appointmentList,appointmentComplete,appointmentCancel,uploadProfilePicture, doctorDashboard,doctorLogout } = require('../controller/doctorController');   
