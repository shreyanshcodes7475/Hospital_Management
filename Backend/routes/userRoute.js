...
const { registerUser, loginUser,getProfile,uploadProfilePicture,bookAppointment,getAppointments,cancelAppointment,editProfile} = require('../controller/userController');
